<template>
  <VueContext ref="menu" class="action-menu-container" @open="opened">
    ...
    <li>
      <button type="button" @click="openReportModal({ report: true, ignore: false })">
        Report User / Message
      </button>
    </li>
    <li>
      <button type="button" @click="openReportModal({ report: false, ignore: true })">
        Ignore User
      </button>
    </li>
    <li v-if="oper && !banned">
    ...
    <li v-if="oper && banned">
      <button type="button" @click="unban">
        Unban User
      </button>
    </li>
    <li v-if="oper">
      <button type="button" @click="kick">
        Kick User
      </button>
    </li>
    <li v-if="oper && !quieted">
      <button type="button" @click="quiet">
        Quiet User
      </button>
    </li>
    <li v-if="oper && quieted">
      <button type="button" @click="unquiet">
        Unquiet User
      </button>
    </li>
    <li>
      <button type="button" @click="privmsg">
    ...
    <li v-if="!starred">
      <button type="button" @click.once="star">
        Star message
      </button>
    </li>
    <li v-if="starred">
      <button type="button" @click="unstar">
        Unstar message
      </button>
    </li>
  </VueContext>
